...
@WebServlet("/AuthDeleteDoctorByEmailServlet")
public class AuthDeleteDoctorByEmailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String deleteSql = "DELETE FROM doctordetails WHERE email = ?";
            ...
            if (rowsDeleted > 0) {
                response.getWriter().println("<p>Doctor record deleted successfully!</p>");
            } else {
